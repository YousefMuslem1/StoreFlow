...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('quantities.entry.index') }}">جميع الكميّات</a></li>
    ...
    <div class="row">
        <div class="col-md-8">
            <form action="{{ route('quantities.entry.add_to_existing_quantity') }}" method="POST">
                @csrf
                <div class="row">
                    {{-- col-4 --}}
                    <div class="col-md-4">
