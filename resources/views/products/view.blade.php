                ...
                <div class="border border-primary p-2">
                    ...
                    <div class="row mt-2 mb-4">
                        <div class="col-md-6">
                            ...
                            <span class="border p-1 text-black" style="font-size: 20px">
                                <b>€</b>{{ $product->calculateSellingPrice() }}</span>
                        </div>
                        @php
                            if ($product->status == 1) {
                                $statusText = 'مباع';
                        ...
                        <div class="col-md-6">
                            ...
                            <span
                                class="border p-1">{{ $statusText  }}</span>
                        </div>
                    </div>
                    <div class="row mt-2 mb-4">
                        <div class="col-md-6">
                    ...
                    <div class="row mt-2 mb-4">
                        ...
                        <div class="col-md-6">
                            <h6 class="d-inline">سعر التحويل :</h6>
                            <span class="border p-1">{{ $product->ounce_price ?? '-' }}</span>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-12">
